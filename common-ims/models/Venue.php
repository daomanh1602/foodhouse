...
class Venue extends MyActiveRecord
{
    ...
    public function rules()
    {
        return [
            [[
                'name', 'search', 'abbr', 'about', 'latlng', 'info', 'link_agoda', 'link_booking', 'link_tripadvisor', 'cruise_meta', 'stype', 'images'
            ], 'trim'],
            [[
    ...
    public function scenarios()
    {
        return [
            ...
            'venues_u'=>[
                'name', 'search', 'abbr', 'about', 'supplier_id', 'latlng', 'info', 'info_facilities', 'image', 'destination_id', 'link_booking', 'link_tripadvisor', 'link_agoda', 'images',
                'cruise_meta', 'stype',
            ],
            'venue/u'=>[
                'abbr',

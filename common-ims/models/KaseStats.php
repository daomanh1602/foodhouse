...
class KaseStats extends MyActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pa_pax', 'pa_pax_ages', 'pa_days', 'pa_start_date', 'pa_tour_type', 'pa_group_type', 'pa_tags'], 'trim'],
    ...
    public function scenarios()
    {
        return [
            ...
            'cases/request'=>['pa_pax', 'pa_pax_ages', 'pa_days', 'pa_start_date', 'pa_tour_type', 'pa_group_type', 'pa_tags'],
            'b2b/kase/c'=>['pa_pax', 'pa_pax_ages', 'pa_days', 'pa_start_date', 'pa_tour_type', 'pa_group_type', 'pa_tags'],
            'b2b/kase/u'=>['pa_pax', 'pa_pax_ages', 'pa_days', 'pa_start_date', 'pa_tour_type', 'pa_group_type', 'pa_tags'],
        ];
    }
    ...
    // {
    //     $this->pa_destinations = implode(',', $this->pa_destinations);
    //     return parent::beforeSave($insert);
    // }

    // public function afterFind()
    // {
    //     $this->pa_destinations = array_filter(explode(',', $this->pa_destinations));

...
class User2 extends MyActiveRecord implements IdentityInterface
{
	...
	{
		return [
			[['fname', 'lname', 'name', 'nickname', 'country_code', 'email', 'phone', 'language', 'timezone', 'info'], 'filter', 'filter'=>'trim'],
			...
			// [['raw_password', 'raw_password_again'], 'required', 'on'=>'changePassword'],
			[['raw_password'], 'string', 'min'=>6, 'max'=>20],
			[['raw_password_again'], 'compare', 'compareAttribute'=>'raw_password', 'on'=>'user/c', 'message'=>'Please repeat your password exactly'],
		];
	}
	...
	{
		return [
			'user/c' => ['fname', 'lname', 'gender', 'bday', 'bmonth', 'byear', 'name', 'nickname', 'country_code', 'status', 'language', 'timezone', 'email', 'phone', 'raw_password', 'raw_password_again'],
